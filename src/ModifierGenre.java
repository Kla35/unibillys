...
public class ModifierGenre extends Stage{
	Genre g;
	int ind;
	
	public ModifierGenre(Genre genre, int index){ 
	...
	Parent fenetrePrincipal() {
		...
		btnValider.setOnAction(e->{
			...
			if (trouve) {
				...
				System.out.println(this.ind + " " + this.g);
				AjouterLivre.genreTemp.set(this.ind, this.g);
				Gestion.saveGenre();
				Gestion.saveLivre();
				Gestion.saveEmprunt();
